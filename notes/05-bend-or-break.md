...
- [28. Decoupling](#28-decoupling)
  - [28.1. Coupling is the enemy of change](#281-coupling-is-the-enemy-of-change)
  - [28.2. Design for flexibility](#282-design-for-flexibility)
  - [28.3. Responsibilities, not containers](#283-responsibilities-not-containers)
  - [28.4. Encapsulation prevents leaky updates](#284-encapsulation-prevents-leaky-updates)
  - [28.5. Avoid method call chains](#285-avoid-method-call-chains)
  - [28.6. Exception: Chains and pipelines](#286-exception-chains-and-pipelines)
  - [28.7. Keep your code shy](#287-keep-your-code-shy)
- [29. Juggling the Real World](#29-juggling-the-real-world)
  - [29.1. Events](#291-events)
  - [29.2. Better Applications](#292-better-applications)
  - [29.3. Finite State Machines (FSM)](#293-finite-state-machines-fsm)
  - [29.4. The Observer Pattern](#294-the-observer-pattern)
  - [29.5. Publish/Subscribe (Pub/Sub)](#295-publishsubscribe-pubsub)
  - [29.6. Reactive Programming, Streams, and Events](#296-reactive-programming-streams-and-events)
- [30. Transforming Programming](#30-transforming-programming)
- [31. Inheritance Tax](#31-inheritance-tax)
  - [31.1. Key Ideas](#311-key-ideas)
  - [31.2. Alternatives to Inheritance](#312-alternatives-to-inheritance)
